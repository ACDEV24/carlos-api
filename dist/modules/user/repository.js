...
class UsersRepository {
    constructor() {
        ...
        this.login = (email) => __awaiter(this, void 0, void 0, function* () {
            return database_1.database.query(`SELECT * FROM ${this.table} WHERE email = '${email}' AND role = 0`).then((value) => {
                if (!value)
                    return {
                        ok: false,
        ...
        this.getAll = () => __awaiter(this, void 0, void 0, function* () {
            return database_1.database.query(`SELECT * FROM ${this.table} AND role = 0`).then((value) => {
                return {
                    ok: true,
                    data: value,
                };
        ...
        this.getById = (id) => __awaiter(this, void 0, void 0, function* () {
            return database_1.database.query(`SELECT * FROM ${this.table} WHERE id = '${id}' AND role = 0`).then((value) => {
                if (!value)
                    return {
                        ok: false,
                        data: 'user not found'
        ...
        this.update = (id, user) => __awaiter(this, void 0, void 0, function* () {
            ...
            email = '${user.email}'
         WHERE id = '${id}' AND role = 0`).then((value) => __awaiter(this, void 0, void 0, function* () {
                if (!value)
                    return {
                        ok: false,
                        data: 'user not found'
        ...
        this.updateStatus = (id, status) => __awaiter(this, void 0, void 0, function* () {
            return database_1.database.query(`UPDATE ${this.table} SET status = ${status} WHERE id = '${id}' RETURNING *`).then((value) => {
                if (!!value)
                    return {
                        ok: false,
                        data: 'user not found'
        ...
        this.delete = (id) => __awaiter(this, void 0, void 0, function* () {
            return database_1.database.query(`delete from ${this.table} WHERE id = '${id}' AND role = 0 RETURNING *`).then((value) => {
                if (!!value)
                    return {
                        ok: false,
                        data: 'user not found'
